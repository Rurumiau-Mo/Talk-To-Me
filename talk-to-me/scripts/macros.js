 /* -----------------------------------------------------------------------------
     ...
     * -----------------------------------------------------------------------------
     *
     * These helpers create copyable macro/script text.
     * The generated scripts are intentionally defensive so they fail with a clear
     * notification instead of throwing "Cannot read properties of undefined".
     */

    /**
     * Generate script text for a TalkToMe managed tile trigger.
     */
    ...
    /**
     * Generate a general speech script for a Foundry hotbar macro or MATT script.
     */
    ...
    /**
     * Generate the safe "open TalkToMe" macro.
     */
